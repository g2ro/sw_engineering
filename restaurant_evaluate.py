...
def get_count():
    ...
    for menu_id in range(len(g_menu_id)):
        ...
        cursor.execute('''INSERT INTO young_cheline.restaurant_evaluate
            (menu_id,menu_name, cleaning, plating, price, restaurant_id, service, taste, couple, drink, family, friend, solo)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)''',
                       (menu, in_menu_name,cleaning, plating, price, restaurant_id, service, avg_taste, couple0, drink3, family1, friend4, solo2))
